...
public class ViewAllBooking extends Activity {
	Button b;
	EditText et,pass;
	TextView tv;
	ListView l;
	...
	ProgressDialog dialog = null;
	  public int currentimageindex=0;
		...
		String symb,desc,mc,mapname,clickedname,clinicid,clinicid2;
		String existing;
		Double lat,lng;
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // 1. get passed intent 
        ...
        Pagename.setTypeface(type);
			...
			Pagename.setText("Existing Appointment");
 ...
 bck.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(getBaseContext(), BookADocHome.class);
				startActivity(intent);
			}
		});
	...
	public String readMaps3() {
		...
		StringBuilder builder = new StringBuilder();
		HttpClient client = new DefaultHttpClient();
		HttpPost httppost= new HttpPost("http://voidq.xyz/appconfig/viewexisting.php"); // make sure the url is correct.
